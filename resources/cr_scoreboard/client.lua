...
function drawnScoreboard()
    ...
    dxDrawText("készül..", center.x - sizes["bottom"].x/2 + 25, y + 2, center.x + sizes["bottom"].x/2, y + sizes["bottom"].y, tocolor(242, 242, 242, alpha), 1, font, "left", "center", false, false, false, true)
