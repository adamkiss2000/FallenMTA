...
function renderSpeedoMeter(positionX, positionY)
    ...
    if enabled then 
		...
		local Speed19 = exports.cr_fonts:getFont("Speed", resp(19))
        ...
        if speed then
            ...
            dxDrawRing(positionX+respc(130), positionY-respc(5), respc(70), respc(70), 0.05, 60, 210, {45/255,46/255,44/255,alpha / 255}, tocolor(100, 100, 100, 0), false, true,1)
            dxDrawRing(positionX+respc(130), positionY-respc(5), respc(70), respc(70), 0.05, 60, nitroCalculation, {100/255,177/255,245/255,alpha / 255}, tocolor(100, 100, 100, 0), false, true,1)
            dxDrawCorrectText(nitroPercentage.."%", positionX+respc(188), positionY+respc(47), respc(70), respc(70), tocolor(255,255,255,alpha), 1, poppinsSemiBold, "center", "top")
            dxDrawImage(positionX+respc(185), positionY+respc(35), respc(30), respc(30), "files/nitro.png", 30, 0, 0, tocolor(255, 255, 255, alpha))
            -- # Draw the fuel circle
			
            local ceiledFuel = math.ceil((monitoredRenderData["veh >> fuel"] or 100))
            local fuelCalculation = math.min(245, ceiledFuel / vehicleMaxFuelTank * 245)
            local fuelPercentage = math.min(100, math.ceil(ceiledFuel / vehicleMaxFuelTank * 100))
			
			dxDrawImage(positionX-respc(45), positionY, respc(284), respc(239), "files/speedofuel.png", 0, 0, 0, tocolor(255, 255, 255, alpha))
            dxDrawRing(positionX+respc(151), positionY+respc(124.4), respc(93), respc(93), 0.05, 145, fuelCalculation, {r/255, g/255, b/255, alpha / 255}, tocolor(100, 100, 100, 0), false, true,1)
			dxDrawImage(positionX-respc(45), positionY, respc(284), respc(239), "files/speedobg.png", 0, 0, 0, tocolor(255, 255, 255, alpha))
            dxDrawCorrectText(fuelPercentage.."%", positionX+respc(162), positionY+respc(185), respc(70), respc(70), tocolor(225,225,225,alpha), 1, poppinsSemiBold, "center", "top")
            --dxDrawRing(positionX-respc(68), positionY-respc(23), respc(285), respc(285), 0.020, 140, maxAngle, {200/255,200/255,200/255,alpha / 255}, tocolor(100, 100, 100, 0), false, true)
            dxDrawRing(positionX-respc(68), positionY-respc(23), respc(285), respc(285), 0.020, 144, calculation, {r/255,g/255,b/255,alpha / 255}, tocolor(100, 100, 100, 0), false, true)
            -- # Draw the actual gear of vehicle
            local vehicleGear = getVehicleCurrentGear(currentVehicle)
			if vehicleGear == 0 then
				vehicleGear = "R"
			end
            dxDrawCorrectText(vehicleGear, positionX-respc(5), positionY+respc(5), respc(160), respc(115), tocolor(180,180,180,alpha), 1, Speed19, "center", "center")
            -- # Draw the kms of the vehicle
            local vehicleKilometers = math.ceil((monitoredRenderData["veh >> odometer"] or 100000))
            dxDrawCorrectText(vehicleKilometers.." km", positionX+respc(24), positionY+respc(219), respc(100), respc(20), tocolor(180,180,180,alpha), 1, poppinsBold16, "center", "center")
			-- # Draw the calculated speed and unit
			dxDrawCorrectText(math.ceil(speed), positionX-respc(5), positionY+respc(90), respc(160), respc(115), tocolor(180,180,180,alpha), 1, Speed19, "center", "center")
			dxDrawCorrectText("KM/H", positionX-respc(5), positionY+respc(120), respc(160), respc(115), tocolor(180,180,180,alpha), 1, poppinsBoldFont19, "center", "center")
            -- # Draw the icons
            ...
            for i = 1, #iconTable do
                ...
                dxDrawImage(positionX-respc(3) + (i-1) * respc(30), positionY+respc(243), respc(24), respc(24), "files/circle.png",0,0,0,tocolor(45,46,44,alpha))
                dxDrawImage(positionX-respc(1) + (i-1) * respc(30), positionY+respc(245), respc(20), respc(20), "files/"..data.image..".png",0,0,0,tocolor(iconColor[1],iconColor[2],iconColor[3], math.min(alpha, animAlpha)))
            end
        end
    end
