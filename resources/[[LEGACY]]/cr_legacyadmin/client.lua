...
addCommandHandler("getpos", 
    function(cmd)
        if exports['cr_permission']:hasPermission(localPlayer, cmd) then
            ...
            -- Kamera mátrix pozíció és nézési pont
            ...
            -- Új kamera pozíció kiírás
            outputChatBox(syntax .. "Camera pos" .. ": " .. green .. camX .. white .. ", " .. green .. camY .. white .. ", " .. green .. camZ, 255, 255, 255, true)
            outputChatBox(syntax .. "Camera look" .. ": " .. green .. lookX .. white .. ", " .. green .. lookY .. white .. ", " .. green .. lookZ, 255, 255, 255, true)
        end
    end
)
        ...
        if target and exports['cr_permission']:hasPermission(localPlayer, "vhSpawn") then
            if getElementData(target, "loggedIn") then
                ...
                if getPedOccupiedVehicle(target) then
	                triggerServerEvent("setElementPosition", localPlayer, getPedOccupiedVehicle(target), 1047.3057861328, 1016.040222168, 11, 0, 0, -1)
	                setElementRotation(target, 0.0, 0.0, 321)
	            else
	            	triggerServerEvent("setElementPosition", localPlayer, target, 1047.3057861328, 1016.040222168, 11, 0, 0, -1)
	                setElementRotation(target, 0.0, 0.0, 321)
                end
