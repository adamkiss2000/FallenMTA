...
addEvent("fuel.setPistolHolder", true)
addEventHandler("fuel.setPistolHolder", root, function(pistolData)
    if isElement(client) then
        setElementData(client, "pistolHolder", pistolData)
    end
end)

addEvent("fuel.removePistolHolder", true)
addEventHandler("fuel.removePistolHolder", root, function()
    if isElement(client) then
        removeElementData(client, "pistolHolder")
    end
end)