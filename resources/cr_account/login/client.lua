...
function drawnLogin()
    ...
    if (moveProgress) then
        ...
        dxDrawText("Adatok megjegyzése", defMid[1] + defSize[1]/2 - 300/2 + 12 + 5, loginPos[1] + defSize[2] + 112.5, defMid[1] + defSize[1]/2 + 300/2, loginPos[1] + defSize[2] + 112.5 + 12, tocolor(242, 242, 242, loginPos[3]), 1, font2, 'left', 'center')
