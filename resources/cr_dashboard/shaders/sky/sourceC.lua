...
function startDynamicSky()
	...
	shaderTable.skyboxTropos = dxCreateShader("shaders/sky/files/shaders/clouds.fx", 2, 0, false, "object")
	shaderTable.skyboxStratos = dxCreateShader("shaders/sky/files/shaders/top.fx", 2, 0, false, "object")
	shaderTable.skyboxBottom = dxCreateShader("shaders/sky/files/shaders/bottom.fx", 3, 0, false, "object")
	shaderTable.clear = dxCreateShader("shaders/sky/files/shaders/clear.fx", 3, 0, false, "world")
	textureTable.cloud = dxCreateTexture("shaders/sky/files/textures/clouds.dds", "dxt5")
	textureTable.normal = dxCreateTexture("shaders/sky/files/textures/clouds_normal.jpg", "dxt5")
	textureTable.skybox = dxCreateTexture("shaders/sky/files/textures/stars.dds", "dxt5")
	moonPhase = getCurrentMoonPhase()
	textureTable.moon = dxCreateTexture("shaders/sky/files/textures/moon/" .. toInteger(20 - toInteger(moonPhase * 20)) .. ".png")
	...
	modelTable.txd = engineLoadTXD("shaders/sky/files/models/cloud.txd")
	engineImportTXD(modelTable.txd, dynamicSkySettings.modelID)

	modelTable.dff = engineLoadDFF("shaders/sky/files/models/cloud.dff", dynamicSkySettings.modelID)
...
function renderTime()
	...
	if thisWeather ~= oldWeather then
		...
		dxSetShaderValue(shaderTable.skyboxTropos, "gCloudSpeed", velocity * 0.03)
		dxSetShaderValue(shaderTable.skyboxBottom, "gCloudSpeed", velocity * 0.03)
	end
