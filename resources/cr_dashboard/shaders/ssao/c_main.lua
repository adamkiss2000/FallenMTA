...
function enableAO()
	...
	if renderTarget.isOn then
		if isAOMaterialPrimitive then
			aoShader.shader, tec = dxCreateShader( "shaders/ssao/fx/primitive3D_ssao_dr.fx" )
		else
			aoShader.shader, tec = dxCreateShader( "shaders/ssao/fx/material3D_ssao_dr.fx" )		
		end
		...
		if isAOMaterialPrimitive then 
			aoShader.shader, tec = dxCreateShader( "shaders/ssao/fx/primitive3D_ssao.fx" )
		else
			aoShader.shader, tec = dxCreateShader( "shaders/ssao/fx/material3D_ssao.fx" )		
		end
	end
