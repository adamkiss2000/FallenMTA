...

        {
            ...
            ["options"] = {
                ...
                },
                {
                    ["name"] = "SSAO",
                    ["type"] = 1,
                    ["optionName"] = "shaders.SSAO",
                    ["nowValue"] = playerOptions["shaders.SSAO"],
                    ["onChange"] = function(oldVal, newVal)
                        playerOptions["shaders.SSAO"] = newVal
                        if playerOptions["shaders.SSAO"] == 1 then 
                            handleonClientSwitchAO(true)
                        else 
                            handleonClientSwitchAO(false)
                        end 
                    end,
                    ["onLoad"] = function()
                        if playerOptions["shaders.SSAO"] == 1 then 
