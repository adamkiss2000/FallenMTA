...
function DxDrawActionbar()
    ...
    if acType == 1 then
        ...
        dxDrawRectangle(ax, ay, w, h, tocolor(40,40,40,alpha * 0.9))
        dxDrawRectangle(ax-1, ay-2, w+2, 2, tocolor(30, 30, 30, alpha * 0.8))
        dxDrawRectangle(ax-1, ay+h, w+2, 2, tocolor(30, 30, 30, alpha * 0.8))
        dxDrawRectangle(ax-1, ay, 2, h, tocolor(30, 30, 30, alpha * 0.8))
        dxDrawRectangle(ax+w-1, ay, 2, h, tocolor(30, 30, 30, alpha * 0.8))
